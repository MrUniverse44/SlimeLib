package me.blueslime.slimelib.utils.plugin.data.spigot;
...
public class BukkitPluginInformation implements SlimePluginInformationSource {
    ...
    public <T> BukkitPluginInformation(T plugin) {
