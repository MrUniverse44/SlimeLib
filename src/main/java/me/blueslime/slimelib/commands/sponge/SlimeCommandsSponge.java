...
public class SlimeCommandsSponge<T extends Server> implements SlimeCommandPlatform {
    ...
    public void register(SlimeCommand command) {
        ...
        if (commandClass.isAnnotationPresent(me.blueslime.slimelib.commands.command.Command.class)) {
            me.blueslime.slimelib.commands.command.Command info = commandClass.getAnnotation(me.blueslime.slimelib.commands.command.Command.class);
