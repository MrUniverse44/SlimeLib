...
import me.blueslime.slimelib.source.console.SlimeConsoleBukkit;
import me.blueslime.slimelib.source.player.SlimePlayer;
...
public class SlimeBukkitCommand extends Command implements TabCompleter {
    private final SlimeCommand command;

    public SlimeBukkitCommand(SlimeCommand command, String description, String usage) {
    ...
    private SlimeSource<?> cast(CommandSender sender) {
        ...
        return SlimeConsoleBukkit.instance();
    }
